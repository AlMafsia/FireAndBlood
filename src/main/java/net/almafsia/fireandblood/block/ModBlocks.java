...
import net.almafsia.fireandblood.block.custom.VolcaniumBlockBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> VOLCANIUM_BLOCK = registerBlock("volcanium_block",
            () -> new VolcaniumBlockBlock(VolcaniumBlockBlock.VOLCANIUM_BLOCK_BEHAVIOUR));
