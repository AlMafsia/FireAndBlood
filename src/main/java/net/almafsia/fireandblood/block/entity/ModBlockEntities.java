...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, FireAndBlood.MOD_ID);

    public static final RegistryObject<BlockEntityType<SmelterBlockEntity>> SMELTER =
